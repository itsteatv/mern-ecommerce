...
function Navbar() {
  ...
  return (
    <>
      {/*<!-- Header --> */}
      <header className="relative z-20 w-full dark:bg-gray-800 bg-white/90 dark:shadow-lg after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full lg:backdrop-blur-sm lg:after:hidden">
